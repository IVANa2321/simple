...
const I18N = {
    en: {
        ...
        info: {
            ...
            cards: [
                {
                    id: "models",
                    label: "VIP AI MODELS",
                    title: "NOVA Orion, Mega and Unity",
          ...
          `,
                },
                {
                    ...
                    title: "NOVA Trading Core architecture",
                    text: "Filtered signals, risk-management and protection from noisy setups.",
                    modalTag: "WHY OUR BOT",
                    modalTitle: "NOVA Trading Core — engine of the mini app",
                    modalHtml: `
            <p><strong>NOVA Trading Core</strong> ingests quotes and discards setups that fail quality checks.</p>
            <ul>
            ...
            items: [
                {
                    ...
                    a: `
            <p>NOVA analyzes market data and keeps only setups that pass risk and entry-quality filters.</p>
          `,
                },
                {
        ...
        analyzer: {
            ...
            idleLine1:
                "Select pair, expiry and AI model to see how NOVA core reacts.",
            idleLine2:
    ...
    ru: {
        ...
        info: {
          ...
          `,
                },
                {
                    ...
                    modalHtml: `
            <p>Мы фокусируем NOVA AI на <strong>Pocket Option</strong>, чтобы точнее моделировать ликвидность и гэпы.</p>
          `,
                },
            ],
        },
            ...
            items: [
                {
                    ...
                    a: `
            <p>NOVA анализирует рынок и оставляет только те сетапы, которые прошли фильтры по риску и качеству входа.</p>
          `,
                },
                {
        ...
        picker: {
            ...
            vipOnlyToast: "Эта опция доступна только с VIP-статусом в боте NOVA.",
...
function setupTradingForm() {
    ...
    function openPicker(type) {
        ...
        // don't autofocus the search field on open – mobile keyboards should stay hidden
        // users can tap the search input when they actually want to search
